...
## How to push and pull into Github
Assuming first that you have connected to your project
You have to elect what is staged by checking it and hit commit
Then write in the comment box something and submit
THEN hit the push or pull errors in top right of screen
See: https://www.youtube.com/watch?v=E2d91v1Twcc
...
I think the R project file is just the directory information - not a notebook or anything - just a tag - so you can get back to that directory with that tag.
