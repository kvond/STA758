...
```
##Opening the file
Students need to open R Studio and download this file from github --

prolly need directions here for the basics of opening
use ```{r, echo = FALSE}
So I don't display output
